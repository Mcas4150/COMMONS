...
spaces_creation(1, "The Mothership", "Wide-open loft, full of sun and stories", 50,
 '10 des pins, Montreal, QC', "Venue", "yes", 75, photo_urls)


photo_urls = %w(http://i.imgur.com/83A8A55.jpg, http://i.imgur.com/r1rcnd3.jpg)

spaces_creation(1, "Textile Park", "Massive Picnic Table, completely open for public us, come add some graffiti", 20,
...
spaces_creation(1, "Birdbrain Barn", "Come sit and ponder how it will all end for you", 80,
...
spaces_creation(1, "Painters Place", "Come paint and you'll feel better", 40,
...
spaces_creation(1, "Splash Laundromat", "Come dance ur sins clean", 200,
...
spaces_creation(1, "Photo Factory", "Come take ur best shot...", 100,
...
spaces_creation(1, "Pillar House", "This is a real place", 80,
...
spaces_creation(1, "350 Cool Roof", "Party Low, Party High on the Flattop", 200,
...
spaces_creation(1, "Vault", "Get away with murder without breaking the bank..", 3000,
